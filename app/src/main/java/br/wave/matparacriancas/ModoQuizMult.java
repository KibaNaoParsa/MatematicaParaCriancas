...
public class ModoQuizMult extends Activity {

    ImageView resA, resB, resC, resD;
    TextView txtA, txtB, txtC, txtD, txtPergunta;
    int n1, n2, teste, pos, resultado;
    Random rand;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        it = new Intent(this, ModoQuizMult.class);
        ...
        txtPergunta.setText(String.valueOf(n1) + " x " + String.valueOf(n2) + " ?");
